...
Tanklagermaterialien = pd.DataFrame(Tanklagermaterialien)
...
AbpackergebindeTanklager = pd.DataFrame(Abpackergebinde)
AbpackergebindeTanklager.drop(columns=['Materialnummer'])
Tanklagermaterialien.to_excel('Test.xlsx')
BenötigtenRohstoffeTanklager.to_excel('Test2.xlsx')
