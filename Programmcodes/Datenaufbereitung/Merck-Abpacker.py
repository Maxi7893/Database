...
Starttermine = pd.read_excel(r'C:\Users\mb-itl-sim\Models\Materialflussanalyse_EL-DOD\Database\Dateien\Starttermine G20 - 2023.xlsx') #Einlesen der Excel Liste für die Produktionstermine
...
Starttermine=pd.read_excel(r'C:\Users\mb-itl-sim\Models\Materialflussanalyse_EL-DOD\Database\Dateien\Produktion_G1.xlsx', header=1) #Einlesen der Excel-Liste G1'
Starttermine['Mat.-Nr.'] = Starttermine['Mat.-Nr.'].str.replace('.' , '') #Punkte aus der Materialnummer entfernen
if b>0:
    Starttermine['Mat.-Nr.'] = Starttermine['Mat.-Nr.'].str[:-b] #hier werden die Materialnummern um die letzten Ziffern gekürzt
...
List1 = pd.read_csv(r'C:\Users\mb-itl-sim\Models\Materialflussanalyse_EL-DOD\Database\Dateien\STUELI_EL-DOD-4.TXT',names=['Werk',
                        'Material',
                        'Al',
                        'Kurztext',
                        'Basismenge',
...
List2 = pd.read_csv(r'C:\Users\mb-itl-sim\Models\Materialflussanalyse_EL-DOD\Database\Dateien\Stückliste G1.TXT',names=['Werk',
                        'Material',
                        'Al',
                        'Kurztext',
                        'Basismenge',
...
Abpacker = pd.read_excel(r'C:\Users\mb-itl-sim\Models\Materialflussanalyse_EL-DOD\Database\Dateien\Abpacker.xlsx', sheet_name=1) #Abpacker werden aus der Excel-Liste eingelesen
...
Abpackergebinde = pd.read_excel(r'C:\Users\mb-itl-sim\Models\Materialflussanalyse_EL-DOD\Database\Dateien\MARA_G1_G20_Gebinde.xlsx')
...
Reinigungskosten = pd.read_excel(r'C:\Users\mb-itl-sim\Models\Materialflussanalyse_EL-DOD\Database\Dateien\Kosten_Reinigung_Gebinde.xlsx')
...
Tanklagermaterialien = pd.read_excel(r'C:\Users\mb-itl-sim\Models\Materialflussanalyse_EL-DOD\Database\Dateien\Belegung Tanklager.xlsx') #Hier ist die zukünftige Tanklagerbelegung
TanklagermaterialienAkt = pd.read_excel(r'C:\Users\mb-itl-sim\Models\Materialflussanalyse_EL-DOD\Database\Dateien\Belegung Tanklager.xlsx', sheet_name=2) #Hier ist die aktuelle Tanklagerbelegung
...
SammlungMaterialnummern = pd.read_excel(r'C:\Users\mb-itl-sim\Models\Materialflussanalyse_EL-DOD\Database\Dateien\Belegung Tanklager.xlsx', sheet_name=1)
